...
const MainImage = () => {
  return (
    <div className="relative w-full h-[480px] overflow-hidden bg-bg rounded-full">
      <Image
      ...
      />
      <div className="absolute w-[400px] top-[90px] right-[210px] z-10 opacity-0 animate-revealUp delay-2000">
        <Image
        ...
        <div className="mt-3 text-[#878787] text-[16px] leading-7">
      ...
      <div className="w-[60%] xl:w-[90%] h-[480px] absolute top-0 right-0 bg-gradient-to-l from-bg from-10% via-bg via-30% to-transparent to-100%"></div>
    </div>
  );
};
